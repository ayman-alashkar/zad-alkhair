...
const SHELL=[
  "./","./index.html","./reader.html","./transfer/","./manifest.json","./migration.js","./vendor/adhan-4.4.4.umd.min.js",
  ...
  "./icons/icon-32.png","./icons/icon-180.png","./icons/icon-192.png","./icons/icon-512.png","./icons/icon-512-maskable.png","./icons/zad-mark.svg","./icons/zad-mark-reverse.svg","./icons/migration-ready-v113.svg"
];
